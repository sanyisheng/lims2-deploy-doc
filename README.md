...
| docker.genee.in/genee/reserv-server | v0.4.0-d2016092201 | https://github.com/17kong/lims2-reserv-server | https://github.com/17kong/lims2-reserv-server |
...
docker run \
    ...
    --restart=always \
    docker.genee.in/genee/reserv-server:v0.4.0-d2016092201
```
