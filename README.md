...
| docker.genee.in/genee/cron-server | v0.1.1-d2017032401 | https://bitbucket.org/genee-yiqikong/cron-server | https://bitbucket.org/genee-yiqikong/cron-server |
...
docker run \
    ...
    --restart=always \
    docker.genee.in/genee/cron-server:v0.1.1-d2017032401
```
