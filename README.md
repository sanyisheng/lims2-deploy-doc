...
| docker.genee.in/genee/cron-server | v1.0.0-d2017102701 | https://bitbucket.org/genee-yiqikong/cron-server | https://bitbucket.org/genee-yiqikong/cron-server | http://od4jrri6r.bkt.clouddn.com/cron-server.new.v1.0.0-d2017102701.tar.gz |
...
docker run \
    ...
    --restart=always \
    docker.genee.in/genee/cron-server:v1.0.0-d2017102701
```
